...
//—————「 Set Nama Bot & Own 」—————//
global.namabot = '𝐒𝐀𝐍𝐒𝐋𝐈𝐍𝐄-𝐁𝐎𝐓'
global.namaowner = 'Rava'

//—————「 Setting Owner 」—————//
global.owner = ['6281212035575']
global.ownernomer = "6281212035575"
global.premium = ['6281212035575']
global.ultah = 'Februari 23, 2024'

//—————「 Setting Donasi 」—————//
global.dana = '081212035575'

//—————「 Set Kebutuhan Button 」—————//
global.email = 'ravagrowtopia@gmail.com'
global.namaweb = 'TikTok'
global.myweb = 'https://tiktok.com/@dryan.am'
global.region = 'Indonesia'
global.github = 'https://ravaachmad.github.io'
global.mygc = '-'
global.myig = 'https://instagram.com/ravaja_'

//—————「 Set Wm 」—————//
global.packname = '𝚂𝚃𝙸𝙲𝙺𝙴𝚁 𝙱𝚈 𝐒𝐀𝐍𝐒𝐋𝐈𝐍𝐄-𝐁𝐎𝐓\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n'
...
global.botname = 'Rava Creator'
global.akulaku = 'Bot By RavaGanz'
global.ttname = '-'
